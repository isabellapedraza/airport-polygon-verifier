...
'''
Testing strategy for bool = point_in_polygon(latitude, longitude, polygon_coords)

partition on len(polygon_coords):               0, 1+

parition on (latitude, longitude):              inside_polygon, on polygon edge, on polygon corner, outside polygon
...
def test_point_in_polygon_empty():
    ...
    longitude = -122.3994
    polygon_coords = []
    result = polygon_checker.point_in_polygon(latitude, longitude, polygon_coords)
